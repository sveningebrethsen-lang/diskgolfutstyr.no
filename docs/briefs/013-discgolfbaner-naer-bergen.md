# Artikkelbrief 013: Discgolfbaner nær Bergen

| Felt | Innhold |
|---|---|
| Arbeidstittel | Discgolfbaner nær Bergen |
| Endelig SEO-title | Discgolfbaner nær Bergen | Diskgolfutstyr |
| Meta description | Praktisk norsk guide til discgolfbaner nær bergen med konkrete råd, interne lenker og tydelig kildebruk. |
| URL/slug | /guider/discgolfbaner-naer-bergen.html |
| Hovedsøkeord | discgolfbaner nær bergen |
| Sekundære søkeord | discgolf norsk, frisbeegolf, discgolf guide |
| Søkeintensjon | Lokal informasjon |
| Målgruppe | Nybegynnere, hobbyspillere og norske discgolfspillere som trenger praktiske råd |
| Artikkeltype | Lokal SEO/baneguide |
| Innholdsklynge | Lokal SEO |
| Brukerreise | Fra spørsmål/problem til trygg neste handling |
| Foreslått H1 | Discgolfbaner nær Bergen |
